...
function SituationClientsWindow({
  ...
  return (
    <div id="client-situation-window" className="flex-1 flex flex-col font-sans text-xs bg-[#f4f7fc] dark:bg-slate-950 text-slate-800 dark:text-slate-100 h-full overflow-hidden select-none">
